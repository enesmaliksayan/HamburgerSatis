...
public class SaglikliBurger extends Hamburger {
    ...
    public double hamburgerBilgileri() {
        ...
        if (this.ilaveSaglikliUrunAdi1 != null) {
            ...
            System.out.println("Ilave Sağlıklı Burger Ürünü:" + this.ilaveSaglikliUrunAdi1 + " Fiyatı :" + this.ilaveSaglikliUrunAdi1);
        }
        if (this.ilaveSaglikliUrunAdi2 != null) {
            toplamUcret += ilaveSaglikliUrunUcreti2;
            System.out.println("Ilave Sağlıklı Burger Ürünü:" + this.ilaveSaglikliUrunAdi2 + " Fiyatı :" + this.ilaveSaglikliUrunAdi2);
        }
